          ...
          <div className="card-conteudo">
            <div>
              <div className="em-dia-card">
                <span>Em dia</span>
                <span className="valor-em-dia-card">
                  {" "}
                  {dadosRelatorio.qtdClientesAdimplentes}{" "}
                </span>
              </div>
              <div className="inadimplentes-card">
                <span>Inadimplentes</span>
                <span className="valor-inadimplentes-card">
                  {" "}
                  {dadosRelatorio.qtdClientesInadimplentes}{" "}
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="card-cobranca">
          ...
          <div className="card-conteudo">
            <div className="previstas-card">
              <span>Previstas</span>
              <span className="valor-previstas-card">
                {" "}
                {dadosRelatorio.qtdCobrancasPrevistas}{" "}
              </span>
            </div>
            <div className="vencidas-card">
              <span>Vencidas</span>
              <span className="valor-vencidas-card">
                {" "}
                {dadosRelatorio.qtdCobrancasVencidas}{" "}
              </span>
            </div>
            <div className="pagas-card">
              <span>Pagas</span>
              <span className="valor-pagas-card">
                {" "}
                {dadosRelatorio.qtdCobrancasPagas}{" "}
              </span>
            </div>
          </div>
        </div>
